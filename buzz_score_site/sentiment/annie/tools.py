...
path_neg_en = os.path.join(DATASET_ROOT, 'sentiment_analysis', 'en', 'rt-polaritydata', 'rt-polarity', 'neg')
path_pos_en = os.path.join(DATASET_ROOT, 'sentiment_analysis', 'en', 'rt-polaritydata', 'rt-polarity', 'pos')
